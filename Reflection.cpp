...
//	return;
//}
//The Render function now takes as input the new reflection textureand reflection matrix.These are then set in the shader before rendering.
...
//	EnableReflectionShader(deviceContext);
//
//	return true;
//}
